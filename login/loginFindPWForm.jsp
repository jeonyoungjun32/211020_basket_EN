...
<script type="text/javascript" src="<%request.getContextPath(); %>js/login/loginPWFind.js"></script>
</head>
<body>
   <section>
        <!--배경 이미지 만들기위한 박스-->
        ...
        <div class="box">
            ...
            <div class="container">
                <div class="form">
                    <h2>비밀번호 찾기</h2>
                    <form action="loginFindPWPro.bk" name="b" method="post">
                        <div class="inputBox">
                            <input type="text" name="id" id="member_id" value="" placeholder="아이디을 입력해주세요">
                        </div>
                        <div class="inputBox">
                      		<input type="text" id="member_email" name="email" value="" placeholder="이메일을 입력해주세요">
                   		</div>
                        <div class="inputBox">
